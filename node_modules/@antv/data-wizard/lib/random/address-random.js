...
var AddressRandom = /** @class */ (function (_super) {
     ...
     */
    AddressRandom.prototype.road = function () {
        var suffixes = ['大道', '路', '街', '胡同'];
        // {@link http://www.sohu.com/a/329066696_99979179}
        // {@link https://baike.baidu.com/tashuo/browse/content?id=b7a9e6fb3d50c9bb99f1fe3b}
        // prettier-ignore
        var roads = ['中山', '朝阳', '大同', '文昌', '长春', '东方', '桃园', '北京', '兴安', '南京', '南昌', '上海', '工业', '文化', '青年', '人民', '建设', '和平', '光明', '复兴', '朝阳', '胜利', '自强', '太平', '幸福', '成功', '永兴', '仁爱', '兴业', '平安', '创业', '健康', '阳光', '牡丹', '竹子', '世纪', '兰花', '梅花', '桂花', '海桐', '白杨', '银霄', '龙溪', '斜阳', '万花', '沧浪', '芒涌', '绿玉', '嵩山', '黄山', '衡山', '长江', '黄河', '珠江', '同福', '兴华', '吉祥', '团结', '长寿', '友爱', '仁廉', '祖冲之', '李时珍', '郭守敬', '李冰', '张衡', '沈括', '蔡伦', '华佗', '毕升', '达尔文', '伽利略', '法拉第', '牛顿', '居里', '哈雷路'];
        return "" + this.pickone(roads) + this.pickone(suffixes);
    };
    /**
     * return a random Chinese address name
     */
    AddressRandom.prototype.address = function () {
        var pcd = [];
        var c = cn_address_dict_1.default;
        while (c) {
            var target = this.pickone(c);
            pcd.push(target.n);
            c = target.c;
        }
