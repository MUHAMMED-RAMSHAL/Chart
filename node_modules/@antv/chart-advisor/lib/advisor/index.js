...
var data_to_advices_1 = require("./advice-pipeline/data-to-advices");
var graph_to_advices_1 = require("./advice-pipeline/graph-to-advices");
var Advisor = /** @class */ (function () {
    ...
    function Advisor(config) {
        ...
        this.CKB = this.ckbCfg ? ckb : ckb_1.CKBJson('en-US', true);
        this.ruleBase = ruler_1.processRuleCfg(this.ruleCfg);
    }
    /**
    ...
    Advisor.prototype.advicesForChart = function (params, exportLog) {
        ...
        var copyData = utils_1.cloneDeep(data);
        var _a = params, fields = _a.fields, fieldTypes = _a.fieldTypes;
        // transform data into DataFrame
        var dataFrame;
        try {
            if (fields) {
                dataFrame = new data_wizard_1.DataFrame(copyData, { columns: fields, columnTypes: fieldTypes });
            }
            else {
                dataFrame = new data_wizard_1.DataFrame(copyData);
            }
        }
        catch (error) {
        ...
        var adviceResult = data_to_advices_1.dataToAdvices(filteredData, dataPropsForAdvice, this.CKB, this.ruleBase, smartColor, tslib_1.__assign(tslib_1.__assign({}, options), { exportLog: exportLog }), colorOptions);
        return adviceResult;
    };
    ...
    Advisor.prototype.advicesForGraph = function (params) {
        ...
        var graphData;
        try {
            graphData = new data_wizard_1.GraphData(copyData, (_a = options) === null || _a === void 0 ? void 0 : _a.extra);
        }
        catch (error) {
            // if the input data cannot be transformed into DataFrame
            return [];
        ...
        var graphDataProps = dataProps ? utils_1.deepMix(calcedProps, dataProps) : calcedProps;
        var advicesForGraph = graph_to_advices_1.graphdataToAdvices(graphData.data, graphDataProps, options);
    ...
    Advisor.prototype.processCKBCfg = function (ckbCfg) {
        ...
        var ckbBase = ckb_1.CKBJson('en-US', true);
        ...
        var finalCkbBase = tslib_1.__assign(tslib_1.__assign({}, ckbBase), ckbCfg.custom);
        return finalCkbBase;
    };
    return Advisor;
}());
exports.Advisor = Advisor;
tslib_1.__exportStar(require("./advice-pipeline"), exports);
tslib_1.__exportStar(require("./ckb-config"), exports);
